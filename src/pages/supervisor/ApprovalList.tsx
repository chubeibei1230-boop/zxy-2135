        ...
        <table className="w-full text-sm border-collapse">
          ...
          <tbody>
            {applications.map((app) => (
              <tr key={app.id} className={`border-b hover:bg-gray-50 ${app.status === 'withdrawn' ? 'opacity-60' : 'cursor-pointer'}`} style={{ borderColor: 'var(--color-border)' }} onClick={() => navigate(`/supervisor/applications/${app.id}`)}>
